...
export const Navbar = () => {
	...
	useEffect(() => {
		// Reinitialize the menu whenever the location changes
		if (userAvatarRef.current) {
			// Suppose this function is from the library you use to initialize the menu
			// e.g., KTMenu.init();
			userAvatarRef.current.click()
			console.log('santa fe', userAvatarRef)
		}
	}, []); */
