...
className="pb-10 pb-lg-15">
        <h2
className="fw-bolder text-gray-900">Account Info</h2>
...
className="mb-10 fv-row">
        <label
className="d-flex align-items-center form-label mb-3">
          Specify Team Size
          <i
...
className="col">
            ...
            >
              <span
className="fw-bolder fs-3">1-1</span>
            </label>
          </div>
...
className="col">
            ...
            >
              <span
className="fw-bolder fs-3">2-10</span>
            </label>
          </div>
...
className="col">
            ...
            >
              <span
className="fw-bolder fs-3">10-50</span>
            </label>
          </div>
...
className="col">
            ...
            >
              <span
className="fw-bolder fs-3">50+</span>
            </label>
          </div>
        </div>
...
className="mb-10 fv-row">
        <label
className="form-label mb-3">Team Account Name</label>
...
className="d-flex flex-column">
                <span
className="fw-bolder text-gray-800 text-hover-primary fs-5">
                  Company Account
                </span>
                <span
...
className="fw-bolder text-gray-800 text-hover-primary fs-5">
                ...
                <span
className="fs-6 fw-bold text-gray-500">Use images to your post time</span>
              </span>
            </span>
...
value="2" />
          ...
          <label
className="d-flex flex-stack mb-0 cursor-pointer">
            <span
className="d-flex align-items-center me-2">
              <span
className="symbol symbol-50px me-6">
