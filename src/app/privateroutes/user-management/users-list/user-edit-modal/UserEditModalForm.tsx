...
import { isNotEmpty, toAbsoluteUrl } from 'src/app/generalcomponents/helpers';
import { initialUser,User } from 'src/models/apimodels/UserManagementModel';
      ...
      <form
        ...
        >
          ...
          <div
            ...
            {/* begin::Label */}
            <label
              className="d-block fw-bold fs-6 mb-5">Avatar</label>
            {/* end::Label */}
          ...
          <div
            ...
            {/* begin::Label */}
            <label
              className="required fw-bold fs-6 mb-2">Full Name</label>
            {/* end::Label */}
          ...
          <div
            ...
            {/* begin::Label */}
            <label
              className="required fw-bold fs-6 mb-5">Role</label>
            {/* end::Label */}
            {/* begin::Roles */}
            {/* begin::Input row */}
            <div
              className="d-flex fv-row">
              {/* begin::Radio */}
              <div
                ...
                <label
                  ...
                  <div
                    className="fw-bolder text-gray-800">Administrator</div>
                  <div
            ...
            {/* end::Input row */}
            <div
              className="separator separator-dashed my-5"></div>
            {/* begin::Input row */}
            <div
              className="d-flex fv-row">
              {/* begin::Radio */}
              <div
                ...
                <label
                  ...
                  <div
                    className="fw-bolder text-gray-800">Developer</div>
                  <div
                    className="text-gray-600">
            ...
            <div
              ...
              <div
                ...
                <label
                  ...
                  <div
                    className="fw-bolder text-gray-800">Analyst</div>
                  <div
                    className="text-gray-600">
            ...
            <div
              ...
              <div
                ...
                <label
                  ...
                  <div
                    className="fw-bolder text-gray-800">Trial</div>
                  <div
                    className="text-gray-600">
