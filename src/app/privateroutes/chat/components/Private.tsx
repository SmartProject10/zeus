...
import { ChatInner,Dropdown1 } from '../../../generalcomponents/partials'
...
className="card-title">
                  <div
className="symbol-group symbol-hover"></div>
                  <div
...
className="mb-0 lh-1">
                      <span
className="badge badge-success badge-circle w-10px h-10px me-1"></span>
                      <span
className="fs-7 fw-bold text-gray-500">Active</span>
                    </div>
                  </div>
                </div>
