...
interface AccidentReportingModalProps {
    saveReporte: (reporte: AccidentsResponse) => void;
    reporte: AccidentsResponse | null;
    mode: 'create' | 'edit' | 'view';
    isCreatingNew: boolean;
}

function AccidentReportingModal({ saveReporte, reporte, mode, isCreatingNew }: AccidentReportingModalProps) {
...
export default AccidentReportingModal;
