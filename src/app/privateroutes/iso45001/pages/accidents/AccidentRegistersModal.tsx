...
interface AccidentRegistersModalProps {
    ...
    saveRegistro: (registro: RegistersResponse) => void
    selectedRegistro: RegistersResponse | null
    isCreatingNew: boolean
}

function AccidentRegistersModal({ reporteSeleccionado, mode, saveRegistro, selectedRegistro, isCreatingNew }: AccidentRegistersModalProps) {

    const initialValuesRegistro: RegistersResponse = {
        noRegistro: '',
    ...
    const [formDataRegistro, setFormDataRegistro] = useState<RegistersResponse>(initialValuesRegistro)
    const [formDataReporte, setFormDataReporte] = useState<AccidentsResponse | null>(null)
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-5">
                                <div className="sticky-top">
                                    ...
                                    {/* Copiar el contenido del modal de AccidentReportingModal */}
                    ...
                    <div className="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div className="modal-content">
                            ...
                            <div className="modal-body d-flex justify-content-center">
                                {previewImage ? (
                                    <img
src={previewImage} alt="Vista previa"
...
export default AccidentRegistersModal
