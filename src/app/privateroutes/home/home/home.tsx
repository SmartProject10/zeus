        ...
        <div>
            <div
                ...
                <div>
                    ...
                    <p
                        className="text-muted fw-bold fs-7">Bienvenido, Usuario</p>
                </div>

                <div>
                    <button
                        className="btn btn-secondary"
                        onClick={() => navigate('/ficha-usuario')}>Ver ficha de usuario</button>
                </div>
            </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p
                                    className="fw-bold mt-0 mb-12">Requieres asistencia u orientación?</p>
                                ...
                                <div
                                    ...
                                    <div
                                        className="card-body">
                                        <p
                                            className="m-0 mb-2">Horario de repuesta</p>
                                        <p
