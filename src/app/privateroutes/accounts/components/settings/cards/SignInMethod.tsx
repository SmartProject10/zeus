    ...
    <div
      ...
      >
        <div
          ...
          <h3
            className="fw-bolder m-0">Sign-in Method</h3>
        </div>
      </div>
        ...
        <div
          ...
          <div
            ...
            <div
              ...
              <div
                className="fs-6 fw-bolder mb-1">Email Address</div>
              <div
                className="fw-bold text-gray-600">support@keenthemes.com</div>
            </div>
                    ...
                    <div
                      ...
                      {formik1.touched.newEmail && formik1.errors.newEmail && (
                        <div
                          ...
                          <div
                            className="fv-help-block">{formik1.errors.newEmail}</div>
                        </div>
                      )}
                    </div>
                  </div>
          ...
          <div
            ...
            <div
              ...
              <div
                className="fs-6 fw-bolder mb-1">Password</div>
              <div
                className="fw-bold text-gray-600">************</div>
            </div>
                    ...
                    <div
                      ...
                      {formik2.touched.newPassword && formik2.errors.newPassword && (
                        <div
                          className="fv-plugins-message-container">
                          <div
                            className="fv-help-block">{formik2.errors.newPassword}</div>
                        </div>
                      )}
                    </div>
                  </div>
          ...
          <div
            ...
            <div
              ...
              <div
                className="mb-3 mb-md-0 fw-bold">
                <h4
                  className="text-gray-800 fw-bolder">Secure Your Account</h4>
                <div
                  className="fs-6 text-gray-600 pe-7">
