...
className="card-title m-0">
          <h3
className="fw-bolder m-0">Notifications</h3>
        </div>
      </div>
...
className="form">
          <div
className="card-body border-top px-9 pt-3 pb-4">
            <div
...
className="fs-6 fw-bold">
                  <tr>
                    <td
className="min-w-250px fs-4 fw-bolder">Notifications</td>
                    <td
className="w-125px">
                      <div
...
htmlFor="project2"></label>
                  ...
                  <tr>
                    <td
className="border-bottom-0">Newsletters</td>
                    <td
