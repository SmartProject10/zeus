...
className="card-title m-0">
          <h3
className="fw-bolder m-0">Deactivate Account</h3>
        </div>
      </div>
...
className="fw-bold">
                  <h4
className="text-gray-800 fw-bolder">You Are Deactivating Your Account</h4>
                  <div
...
className="fv-plugins-message-container">
                <div
className="fv-help-block">{formik.errors.confirm}</div>
              </div>
            )}
          </div>
