      ...
      <form
        ...
        <div
          ...
          <div
            className="row mb-8">
            <label
              className="col-lg-3 col-form-label">Username</label>
            <div
              className="col-lg-9">
              <div
          ...
          <div
            ...
            <div
              ...
              <div
                ...
                <span
                  className="input-group-text pe-0">
                  <i
                    className="la la-at fs-4"></i>
                </span>
                <input
                  type="text"
                  className="form-control form-control-lg form-control-solid"
          ...
          <div
            className="row mb-8">
            <label
              className="col-lg-3 col-form-label">Language</label>
            <div
              className="col-lg-9">
              <select
              ...
              >
                ...
                <option
                  value="eu">Euskara - Basque (beta)</option>
                <option
          ...
          <div
            className="row mb-8">
            <label
              className="col-lg-3 col-form-label">Time Zone</label>
            <div
              className="col-lg-9">
              <select
                className="form-select form-select-lg form-select-solid"
          ...
          <div
            ...
            <label
              className="col-lg-3 col-form-label">Communication</label>
            <div
              className="col-lg-9">
              <div
          ...
          <div
            className="separator separator-dashed my-10"></div>

          {/* begin::Form row */}
          <div
            className="row mb-8">
            <label
              className="col-lg-3 col-form-label">Login verification</label>
            <div
              className="col-lg-9">
              <button
                type="button"
          ...
          <div
            className="row mb-13">
            <label
              className="col-lg-3 col-form-label">Password reset verification</label>
            <div
              className="col-lg-9">
              <div
                className="form-check form-check-custom form-check-solid me-5">
