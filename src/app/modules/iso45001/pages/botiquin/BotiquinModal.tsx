...
function BotiquinModal({ setNewData }) {
    const { handleSubmit, getFieldProps, touched, errors, isValid, isSubmitting } = useFormik({
        initialValues,
                            ...
                            <div className="card-body bg-secondary ">
                                <div className="row gy-4 ">
                                    <div className="col-sm-6">
                                        <label htmlFor="codigo" className="required form-label">Código</label>
                                        <input
                                            type="text"
                                            className={clsx(
                                                'form-control ',
                        ...
                        <div className="card shadow-none mb-0">
                            <div className="card-body bg-secondary ">
                                <div className="row gy-4 mb-10">
                                    ...
                                    <div className="col-sm-6">
                                        <label htmlFor="fechaVencimiento" className="required form-label">Fecha vencimiento</label>
                                        <input
                                            type="date"
                                            className="form-control"
                                    ...
                                    <div className="col-12 text-end">
                                        <button type="button" onClick={handleAddEditTableData} className="btn btn-sm btn-primary">
