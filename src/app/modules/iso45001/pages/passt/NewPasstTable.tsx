...
function NewPasstTable({ dataSource, handleDeleteData }: any) {
						...
						<tbody>
							{dataSource.length > 0 ? (
								...
								<tr className="text-center">
									<td colSpan={7}>No se encontraron botiquines.</td>
								</tr>
							)}
						</tbody>
					</table>
