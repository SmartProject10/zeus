...
className="fw-bolder my-2">
          My Campaigns
          <span
className="fs-6 text-gray-500 fw-bold ms-1">30 Days</span>
        </h3>

        <div
className="d-flex align-items-center my-2">
          <div
className="w-100px me-5">
            <select
              name="status"
            ...
            >
              <option
value="1">30 Days</option>
              <option
value="2">90 Days</option>
              <option
value="3">6 Months</option>
              <option
value="4">1 Year</option>
            </select>
          </div>
          <button
