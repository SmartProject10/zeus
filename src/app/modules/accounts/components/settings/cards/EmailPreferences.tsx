...
className="card-title m-0">
          <h3
className="fw-bolder m-0">Email Preferences</h3>
        </div>
      </div>
...
className="form">
          <div
className="card-body border-top px-9 py-9">
            <label
...
className="form-check-label d-flex flex-column align-items-start">
                <span
className="fw-bolder fs-5 mb-0">Successful Payments</span>
                <span
className="text-muted fs-6">
            ...
            <div
className="separator separator-dashed my-6"></div>
...
className="form-check-label d-flex flex-column align-items-start">
                <span
className="fw-bolder fs-5 mb-0">Payouts</span>
                <span
className="text-muted fs-6">
...
className="form-check-label d-flex flex-column align-items-start">
                <span
className="fw-bolder fs-5 mb-0">Fee Collection</span>
                <span
className="text-muted fs-6">
...
className="form-check-label d-flex flex-column align-items-start">
                <span
className="fw-bolder fs-5 mb-0">Customer Payment Dispute</span>
                <span
className="text-muted fs-6">
...
className="form-check-label d-flex flex-column align-items-start">
                <span
className="fw-bolder fs-5 mb-0">Refund Alerts</span>
                <span
className="text-muted fs-6">
...
className="form-check-label d-flex flex-column align-items-start">
                <span
className="fw-bolder fs-5 mb-0">Invoice Payments</span>
                <span
className="text-muted fs-6">
...
className="form-check-label d-flex flex-column align-items-start">
                <span
className="fw-bolder fs-5 mb-0">Webhook API Endpoints</span>
                <span
className="text-muted fs-6">
...
className="card-footer d-flex justify-content-end py-6 px-9">
            <button
className="btn btn-lightbtn-active-light-primary me-2">Discard</button>
            <button
type="button"
onClick={click}
