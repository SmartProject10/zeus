...
export const CompanyCard = memo(
    (props: CompanyCardProps) => {
        ...
        return (
            <div
className="company-card d-flex flex-column w-100">
                <div
...
loading="lazy" />
                ...
                <p
className="name fw-bold fs-5 mb-0 mt-4">{companyName}</p>
                <p
className="details fs-7">{companyDetails}</p>

                <button
className="btn btn-info btn-sm w-100 position-relative"
onClick={handlePress}>
                    Ingresar
                    <span
